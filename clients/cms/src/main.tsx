...
const router = createBrowserRouter([
  {
    ...
    element: (
      <div className="flex h-full items-center justify-center">
        <Card>
          <h1 className="font-heading-lg">Content Management<br/>System</h1>
          <h2 className="font-heading-md">Content Management<br/>System</h2>
          <h3 className="font-heading-sm">Content Management<br/>System</h3>
          <p className={"w-[50ch]"}>
